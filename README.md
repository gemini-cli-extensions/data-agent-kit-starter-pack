...
```bash
gemini extensions install https://github.com/gemini-cli-extensions/data-agent-kit-starter-pack --ref 0.7.0
```
</details>
...
**macOS / Linux:**
```bash
CODEX_TAG="0.7.0"; curl -sSL https://raw.githubusercontent.com/gemini-cli-extensions/data-agent-kit-starter-pack/$CODEX_TAG/codex-install.sh | bash -s -- $CODEX_TAG
```

**Windows:**
```powershell
$env:CODEX_TAG="0.7.0"; irm "https://raw.githubusercontent.com/gemini-cli-extensions/data-agent-kit-starter-pack/$env:CODEX_TAG/codex-install.ps1" | iex
```
...
Edit the configuration file:
`~/.claude/plugins/cache/claude-plugins-official/data-agent-kit-starter-pack/0.7.0/.claude-mcp.json`
</details>
...
`~/.codex/plugins/cache/data-agent-kit-starter-pack-marketplace/dak/0.7.0/.mcp.json`
