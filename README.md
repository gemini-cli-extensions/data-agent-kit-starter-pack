...
Edit the configuration file:
`~/.claude/plugins/cache/claude-plugins-official/data-agent-kit-starter-pack/0.4.1/.claude-mcp.json`
</details>
...
`~/.codex/plugins/cache/data-agent-kit-starter-pack-marketplace/dak/0.4.1/.mcp.json`
