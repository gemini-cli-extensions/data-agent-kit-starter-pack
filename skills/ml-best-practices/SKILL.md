...
-   Detect and profile outliers using statistical methods appropriate for the
    distribution (e.g., IQR via quantiles for skewed data, z-score).
-   Quantify outlier counts and determine whether to retain valid domain
    entities with justification or handle anomalies.
