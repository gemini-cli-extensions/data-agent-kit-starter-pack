...
-   Perform statistical tests for stationarity (e.g., ADF, KPSS). In a markdown
    cell, explicitly discuss the test results, including p-values and modeling
    implications (e.g., need for differencing).
