...
try:
  from google3.third_party.data_agent_kit.data_agent_common.skills.gcs_security_assessment.scripts import cloud_rest_helpers_nodeps
  from google3.third_party.data_agent_kit.data_agent_common.skills.gcs_security_assessment.scripts import validation
except ImportError:
...
# TODO: b/504696531 - Update scoring logic to be more robust.
