...
from declarative_dags_models.v2.action_models import PapermillActionModel
from declarative_dags_models.v2.trigger_models import ScheduleTriggerModel
...
AnyAction = Union[PapermillActionModel]
...
class PipelineModel(BaseModel):
  ...
  def build(cls, definition: dict):
    try:
      ...
      print(f'PipelineModel validation error: \n{e}')
      return None
