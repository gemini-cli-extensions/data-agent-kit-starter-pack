...
5.  **Execute script**: When requested to run a job, script, or session, refer
    to `references/gcloud_dataproc.md` on how to execute generated code on
    Managed Spark. This DOES NOT apply when generating notebooks (use
    `execute_cell` tool).
