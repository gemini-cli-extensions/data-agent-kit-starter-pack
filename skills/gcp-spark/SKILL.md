...
3.  **Generate spark code**:
    ...
    *   **Feature Engineering**: **ALWAYS** refer to
        `references/feature_engineering.md` when performing feature engineering
        tasks like one-hot encoding or train/test splits.
