...
-   **Dependency**:
    ...
    (or
    `spark.jars.packages=com.google.cloud.spark:spark-bigquery-with-dependencies_2.12:0.36.4`
    /
    `--packages=com.google.cloud.spark:spark-bigquery-with-dependencies_2.12:0.36.4`)
-   **Notes**: Pass `--jars` or `--packages` when submitting batch jobs or
...
-   **Dependency**:
    `spark.jars.packages=com.google.cloud.bigtable:bigtable-hbase-2.x-hadoop:2.14.3`
    (or `--packages=com.google.cloud.bigtable:bigtable-hbase-2.x-hadoop:2.14.3`)
-   **Notes**: Used for Bigtable HBase catalog integration
...
-   **Dependency**:
    `spark.jars.packages=com.google.cloud:pubsublite-spark-sql-streaming:1.0.1`
    (or `--packages=com.google.cloud:pubsublite-spark-sql-streaming:1.0.1`)
-   **Notes**: Used for streaming and batch event ingestion from Pub/Sub Lite
